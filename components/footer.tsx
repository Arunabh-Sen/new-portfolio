...
const navigation = [
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/in/arunabh-sen-a0622b29b/',
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/arun_xabh', // replace with your actual username
    icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/Arunabh-Sen',
    icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
      <svg fill='currentColor' viewBox='0 0 24 24' {...props}>
        <path
          fillRule='evenodd'
  ...
  {
    name: 'X',
    href: 'https://x.com/arux_nabh', // replace with actual handle if different
    icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
      <svg fill='currentColor' viewBox='0 0 24 24' {...props}>
        ...
        <div className='md:flex md:items-center md:justify-between'>
          ...
          <div className='mt-8 text-center md:order-1 md:mt-0 md:text-left'>
            <p className='text-xs leading-5 text-muted-foreground'>
              &copy; {new Date().getFullYear()} Arunabh Sen. All rights
              reserved.
            </p>
          </div>
        </div>
